    ...
    <body class="sub_page">
        ...
        <section class="manager_section layout_padding">
            <div class="container">
                ...
                <p>NOTE: You can't update the ID.</p>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form_container">
                            <form action="accmng" method="post">
                                ...
                                <input type="text" name="id" value="${account.id}" class="min_width_400px" readonly><br>
                                <label class="min_width_140px">User:</label>
                                <input type="text" name="user" value="${account.user}" class="min_width_400px"
                                       required><br>
                                <label class="min_width_140px">Password:</label>
                                <input type="text" name="pass" value="${account.pass}" class="min_width_400px"
                                       required><br>
                                <label class="min_width_140px">IsSell:</label>
                                <input type="text" name="isSell" value="${account.isSell}" class="min_width_400px"
                                       required><br>
                                <label class="min_width_140px">IsAdmin:</label>
                                <input type="text" name="isAdmin" value="${account.isAdmin}" class="min_width_400px"
                                       required><br>
