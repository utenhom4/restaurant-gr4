            ...
            <div class="container  ">
                ...
                <div class="row">
                    <div style="display: flex; justify-content: space-between; width: 100%">
                        ...
                        <span>
                            <button class="btn btn-dark margin_bottom_40px"><a href="insertproduct.jsp" style="color: white;">Insert</a></button>
                        </span>
                    </div>
                    ...
                    <table>
                        ...
                        <c:forEach items="${menus}" var="menu" >
                            <tr>
                                <td>${menu.menuId}</td>
                                <td>${menu.menuName}</td>
                                <td>${menu.typeOfFood}</td>
                                <td>${menu.quantity}</td>
                                <td>$${menu.price}</td>
                                <td><img src="${menu.picture}" alt="${menu.menuName}"></td>
                                <td>${menu.detail}</td>
                                <td><a href="promng?action=display_menu&amp;menuId=${menu.menuId}">Update</a></td>
                                <td><a href="promng?action=delete_menu&amp;menuId=${menu.menuId}">Delete</a></td>
