...
<%@include file = "header.jsp"%>
        ...
        <section class="book_section layout_padding">
            ...
            <div class="container">
                ...
                <p>Thanks for booking in our restaurant.</p>
                <div class="form_container">
                    ...
                    <form>
                        Hello ${book.cusName}. Here is your information.<br>
                        Your email is ${book.cusEmail}<br>
                        You have booked table ${book.idTable} for ${book.people} on ${book.time}<br>                                 
                        Your phone number is ${book.cusPhone}<br> 
                    </form>
                </div>
                <p>See you soon!</p>
